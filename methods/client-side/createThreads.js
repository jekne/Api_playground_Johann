...
createThreads("220c3c8d-398b-409e-adc3-febcef049615").then((r) =>
  console.log(r)
);

//the way it works, when  you have the message you have the id of this message (big number on the dashboard), the tread will reply on the
